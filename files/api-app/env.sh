...
export NODE_APP='api.js'
export NODE_APP_DESCRIPTION='Node.js API demo application'
...
export SYSD_TMPL_FILE='api.node.service.tmpl'

## Systemd configuation files and directory path in VM
export SYSD_CONF_FILE='api.node.service'
